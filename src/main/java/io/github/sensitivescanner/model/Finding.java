...
public final class Finding {
    private final String fingerprint, ruleId, category, type, description, fieldName, detectionPath, maskedEvidence, valueHash;
    ...
    public Finding(String fingerprint,String ruleId,String category,String type,String description,Severity severity,
                   Confidence confidence,Location location,String fieldName,String detectionPath,String maskedEvidence,
        ...
        this.detectionPath=detectionPath;this.maskedEvidence=maskedEvidence;this.valueHash=valueHash;this.traffic=traffic;
    ...
    public String detectionPath(){return detectionPath;} public String maskedEvidence(){return maskedEvidence;} public String valueHash(){return valueHash;}
